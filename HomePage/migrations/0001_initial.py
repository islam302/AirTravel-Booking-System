# Generated by Django 5.0 on 2024-01-28 11:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passenger', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='passenger_tickets', to='HomePage.passenger')),
            ],
        ),
        migrations.AddField(
            model_name='passenger',
            name='ticket',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='passenger_tickets', to='HomePage.ticket'),
        ),
        migrations.AddField(
            model_name='flight',
            name='tickets',
